...
async def process_message_core(user_id: str, text: str) -> str:
    ...
    prompt += "Ответь по существу, с рассуждениями, советами, анализом и рефлексией. Максимум 6 предложений"
    prompt += "Если вопрос простой – дай прямой ответ 3 предложения. Не повторяй историю диалога."
