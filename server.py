...
async def process_message_core(user_id: str, text: str) -> str:
    ...
    messages = [
        {"role": "system", "content": "Ты — Феон. Отвечай на вопрос пользователя по существу, максимум 5-7 предложения. С философией и пояснениями. Если есть контекст или история, используй их для ответа."},
